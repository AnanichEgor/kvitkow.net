        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_Users_UserDBId",
                        column: x => x.UserDBId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDBId = table.Column<string>(nullable: true),
                    ProfileSettingsId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Profiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Profiles_ProfileSettings_ProfileSettingsId",
                        column: x => x.ProfileSettingsId,
                        principalTable: "ProfileSettings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Profiles_Users_UserDBId",
                        column: x => x.UserDBId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleDB_Groups_GroupDBId",
                        column: x => x.GroupDBId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoleDB_Users_UserDBId",
                        column: x => x.UserDBId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketDB", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TicketDB_Users_UserDBId",
                        column: x => x.UserDBId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserGroupDB_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Profiles_ProfileSettingsId",
                table: "Profiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleDB_GroupDBId",
                table: "RoleDB",
                column: "GroupDBId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleDB_UserDBId",
                table: "RoleDB",
                column: "UserDBId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketDB_UserDBId",
                table: "TicketDB",
                column: "UserDBId");
