...
namespace IdentityServer.UserManagmentClient.Api
{
    ...
    public interface IUserApi
    {
        ...
        /// <returns>ForViewModel</returns>
        ForViewModel UserGetByLogin (string login);
        /// <summary>
        ///  
        /// </summary>
        /// <param name="ids"></param>
        /// <returns>bool?</returns>
        bool? UserGetByString (string ids);
        /// <summary>
        ///  
        /// </summary>
        ...
        /// <returns>bool?</returns>
        bool? UserUpdate (string id, ForUpdateModel userModel);
    }
    ...
    public class UserApi : IUserApi
    {
        ...
        /// <param name="login"></param> 
        /// <returns>ForViewModel</returns>            
        public ForViewModel UserGetByLogin (string login)
        {
        ...
        /// <param name="ids"></param> 
        /// <returns>bool?</returns>            
        public bool? UserGetByString (string ids)
        {
            
            // verify the required parameter 'ids' is set
            if (ids == null) throw new ApiException(400, "Missing required parameter 'ids' when calling UserGetByString");
            
    
            var path = "/api/users/{ids}";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling UserGetByString: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling UserGetByString: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="userModel"></param> 
        /// <returns>bool?</returns>            
        public bool? UserUpdate (string id, ForUpdateModel userModel)
        {
